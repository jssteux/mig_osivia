repos=$HOME/Dev/portal-modules-repos/common/1.2.5/lib
...
cp common/target/common-common-1.2.5.jar $loc/portal-common-lib.jar
cp mc/target/common-mc-1.2.5.jar $loc/portal-common-mc-lib.jar
cp portal/target/common-portal-1.2.5.jar $loc/portal-common-portal-lib.jar
